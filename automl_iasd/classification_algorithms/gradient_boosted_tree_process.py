...
s3.put_object(
     ...
     Key=f'{automl_instance_model_path}/GradientBoostedTree_{aucroc_on_test}/metrics'
)
# We finally end up by saving the found model 
best_model.save(f"s3a://{bucket_name}/{automl_instance_model_path}/GradientBoostedTree_{aucroc_on_test}/model")
